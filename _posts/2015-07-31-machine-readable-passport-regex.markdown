...
date:   2015-07-31 16:03:49 
tags: tech regex
keywords: "regex mrp passport"
...
As can be found on the [Wikipedia page](https://en.wikipedia.org/wiki/Machine-readable_passport), the format of the first row can be defined as
...
Below the implementation or to see it in a better format the same version can be found on [Regex101](https://regex101.com/r/kI6aG3/6); I am planning to give it a check in the near future to see if I can make it better...
